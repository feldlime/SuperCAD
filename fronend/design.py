...
class Ui_SuperCAD(object):
    def setupUi(self, SuperCAD):
        ...
        self.Point.raise_()
        self.Line.raise_()
        self.fix_angle.raise_()
        self.fix_length.raise_()
        self.combine_points.raise_()
        self.point_on_middle_line.raise_()
        self.horizontally.raise_()
        self.point_on_line.raise_()
        self.fix_point.raise_()
        self.normal.raise_()
        self.fix_size.raise_()
        self.parallelism.raise_()
        ...
        self.actionColse = QtWidgets.QAction(SuperCAD)
        self.actionColse.setObjectName("actionColse")
        self.actionExit = QtWidgets.QAction(SuperCAD)
        self.actionExit.setObjectName("actionExit")
        self.actionBack = QtWidgets.QAction(SuperCAD)
        self.actionBack.setObjectName("actionBack")
        self.actionRede = QtWidgets.QAction(SuperCAD)
        ...
        self.menuMenu.addAction(self.actionRede)
    ...
    def retranslateUi(self, SuperCAD):
        ...
        self.actionColse.setText(_translate("SuperCAD", "Colse"))
        self.actionColse.setShortcut(_translate("SuperCAD", "Ctrl+W"))
        self.actionExit.setText(_translate("SuperCAD", "Exit"))
        self.actionExit.setShortcut(_translate("SuperCAD", "Ctrl+Q"))
        self.actionBack.setText(_translate("SuperCAD", "Undo"))
        self.actionBack.setShortcut(_translate("SuperCAD", "Ctrl+Z"))
        self.actionRede.setText(_translate("SuperCAD", "Rede"))
        self.actionRede.setShortcut(_translate("SuperCAD", "Ctrl+Shift+Z"))
